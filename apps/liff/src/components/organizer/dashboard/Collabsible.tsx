      ...
      <Collapsible open={isOpen} onOpenChange={setIsOpen}>
        ...
        <CollapsibleContent>
          <div className='mt-12 flex gap-12'>
            ...
            <h1 className='text-semi-18'>Attendee A</h1>
          </div>
          <div className='mt-12 flex gap-12'>
            <CgProfile />
            <h1 className='text-semi-18'>Attendee A</h1>
...
export function CollabsibleDenied() {
  const [isOpen, setIsOpen] = useState(false);
  return (
    <div className='rounded-24 bg-white-pure mx-auto mt-[19px] w-[345px] pb-[6px] pl-[16px] pr-[9px] pt-[8px]'>
      <Collapsible open={isOpen} onOpenChange={setIsOpen}>
...
export function CollabsibleUnanswered() {
  const [isOpen, setIsOpen] = useState(false);
  return (
    <div className='rounded-24 bg-white-pure mx-auto mt-[19px] w-[345px] pb-[6px] pl-[16px] pr-[9px] pt-[8px]'>
      <Collapsible open={isOpen} onOpenChange={setIsOpen}>
        <CollapsibleTrigger className='flex w-full items-center justify-between'>
          <h1 className='text-semi-18'>Unanswered Invitation</h1>
          <div className='flex w-[44px] items-center gap-8'>
            <h1 className='text-semi-18 text-[#F6BB0A]'>10</h1>
            <IoChevronDownOutline
              className={`mt-[3px] transition-transform duration-300 ${isOpen ? 'rotate-180' : 'rotate-0'}`}
            />
          </div>
