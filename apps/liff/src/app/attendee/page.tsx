  ...
  return (
    <div className='flex h-full w-full flex-col items-center gap-5 overflow-y-auto'>
      <div className='flex w-full flex-row items-center justify-center gap-4 px-4'>
        <Input
          className='bg-white-pure mt-8 max-w-[85vw] px-5'
        ...
        />
        <Button
          className={`rounded-full ${activeFilter ? 'text-orange-2 bg-white-bg' : 'bg-orange-6'} mt-8`}
          size='icon'
          variant='ghost'
      ...
      {showFilters && (
        <div className='bg-white-bg w-full rounded-3xl border border-gray-200 p-3 shadow-lg'>
  ...
  return (
    <div className='flex h-full w-full flex-col'>
      ...
      <div className='bg-orange-5 h-full w-full bg-[url(/create-bg.svg)]'>
        ...
        <div className='flex h-full w-full flex-col gap-16 overflow-y-auto px-4 pt-12'>
          <EventContainer />
        </div>
      </div>
    </div>
